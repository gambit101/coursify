...
const Footer = () => {
    return (
        <div className="bg-[#003153]">
            <footer className="footer p-10  text-white px-20 bg-[#003153]">
                <div>
            ...
            <footer className="footer px-20 py-4 border-t border-base-300  text-white bg-[#003153]">
                <div className="items-center grid-flow-col">
                    ...
                    <p>Coursify Industries Ltd. <br />Providing reliable tech since 1992</p>
                </div>
